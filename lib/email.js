...
const STAGE_MESSAGES = {
  1: {
    ...
    body: (name, orderNum) => `
      ...
      <a href="https://peak-mouthguards.vercel.app/track.html?order=${orderNum}">peakmouthguards.com/track — ${orderNum}</a></p>
    `
  },
  2: {
    ...
    body: (name, orderNum) => `
      ...
      <a href="https://peak-mouthguards.vercel.app/track.html?order=${orderNum}">Track order ${orderNum}</a></p>
      <p>Need help? Check our <a href="https://peak-mouthguards.vercel.app/guide.html">step-by-step impression guide</a> or reply to this email.</p>
    `
  },
  3: {
    ...
    body: (name, orderNum) => `
      ...
      <p><a href="https://peak-mouthguards.vercel.app/track.html?order=${orderNum}">Track order ${orderNum}</a></p>
    `
  },
  4: {
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;max-width:600px;width:100%;">
            ...
            <tr>
              <td style="background:#F4F4F4;padding:20px 32px;font-size:11px;color:#999999;text-align:center;">
                Peak Mouthguards · Irvine, CA · <a href="https://peak-mouthguards.vercel.app" style="color:#D0021B;">peakmouthguards.com</a>
              </td>
            </tr>
          </table>
        </td></tr>
...
async function sendConfirmationEmail({ to, first_name, order_number, option, color, amount_cents, addr_line1, city, state, zip }) {
  ...
  const html = `
    ...
    <p style="margin-top:24px;">
      <a href="https://peak-mouthguards.vercel.app/track.html?order=${order_number}" 
...
async function sendStageEmail({ to, first_name, order_number, stage, stage_name, tracking }) {
...
module.exports = { sendConfirmationEmail, sendStageEmail };
